...
output_folder <- "output/plots_Andries_Sen2/"
...
# 2. Load plot center points and ensure they match Sentinel-2 CRS
plots_sf <- st_as_sf(
  data.frame(ID = c("Plot1", "Plot2"),
             X = c(201792.95, 210392.953),
             Y = c(220295.68, 221095.68)),
  coords = c("X", "Y"),
  crs = 31370  # Original CRS (Lambert72)
)

# 3. Load and reproject `bosvl2001` to match Sentinel-2 CRS
